...
getgenv().GAG2 = {
    ...
    BuyGearShop = {
        ...
        "Super Sprinkler", "Super Watering Can", "Trowel", "Legendary Sprinkler", "Harp",
    },
    ...
    MailSendItems = {
		["Super Watering Can"] = { Amount = "5", To = { "Unitopikazf" } },
        ["Super Sprinkler"] = { Amount = "5", To = { "Unitopikazf" } },
    },
