...
getgenv().GAG2 = {
    ...
    UseSprinklers = { "Common Sprinkler" },

    CollectSeedPacks = true,

    COLLECT_PLANT_IF_MUTATED = {
        "Sunflower", "Venus Fly Trap", "Fire Fern", "Mushroom", "Rocket Pop",
        "Bamboo", "Pomegranate", "Poison Apple", "Acorn", "Coconut",
        "Dragon Fruit", "Mango", "Banana", "Grape", "Pineapple"
    },
    ...
    MailSendItems = {
        ...
        ["Common Seed Pack"] = "All",
        ["Uncommon Seed Pack"] = "All",
        ["Rare Seed Pack"] = "All",
